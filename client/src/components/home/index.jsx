...
import { getAllCountries, sortAlphabet,sortPopulation,filterContinent,filterActivities,sortArea} from "../../Redux/actions/index";
import CountryCard from "../countryCard/index";
import s from "./index.module.css"
import image from "../../Images/prueba2.jpg"
import vid from "../../Images/loading.gif"
...
export default function Home() {
    ...
    const filterCountries= ()=>{
        ...
        }else if(allCountries.length>0 && search.length>0 || search.length>0 ){
            if(currentPage===1){
                console.log(search)
